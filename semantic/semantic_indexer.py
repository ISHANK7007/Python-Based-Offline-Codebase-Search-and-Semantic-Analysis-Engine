...
class SemanticIndexer:
    ...
    def process_element(self, element: Any) -> Any:
        ...
        # ✅ Semantic enrichment added here
    ...
    def analyze_function_element(self, function_element: FunctionElement) -> FunctionElement:
        ...
        roles = self.function_role_analyzer.determine_roles(function_element)
        function_element.semantic_roles = roles

        decorator_info = self.decorator_analyzer.process_decorators(function_element.decorators)
        function_element.decorator_metadata = decorator_info
